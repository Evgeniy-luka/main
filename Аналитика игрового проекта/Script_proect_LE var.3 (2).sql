...
проверь пожалуйста (2) CTE для определения количества внутриигровых покупателей и доли платящих
у меня уже глаз замылился. Есть сомнения что я правильно высчитываю "Количество уникальных платящих игроков"
